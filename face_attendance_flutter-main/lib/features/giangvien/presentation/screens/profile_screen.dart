...
import '../../data/models/giangvien_model.dart'; // ✅ Import model
...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Giảng viên Khoa ${currentGV.khoa}",
              ...
              child: ListView(
                children: [
                  _buildInfoSection(
                    ...
                    infoList: [
                      {"label": "Mã giảng viên", "value": currentGV.maGV},
                      {"label": "Khoa", "value": currentGV.khoa},
                      {"label": "Email", "value": currentGV.email},
                      {"label": "SĐT", "value": currentGV.sdt},
                    ],
                  ),
                  const SizedBox(height: 10),
                  _buildInfoSection(
                  ...
                  _buildInfoSection(
                    title: "Giới thiệu",
                    infoList: [
                      {"label": "", "value": currentGV.gioiThieu},
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildInfoSection({
    ...
    required List<Map<String, String>> infoList,
  }) {
    return Container(
